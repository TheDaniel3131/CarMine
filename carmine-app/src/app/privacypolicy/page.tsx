          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <section>
              ...
              <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                CarMine is committed to protecting your privacy. This Privacy
            ...
            <section>
              ...
              >
                ...
                subscribe to our newsletter, fill out a form, or otherwise
              ...
              >
                ...
                <li>
                  Information about vehicles you are selling or interested in
                  buying
                </li>
            ...
            <section>
              ...
              >
                ...
                <li>
                  ...
                  rights, property, and safety of CarMine or others
                </li>
                <li>
            ...
            <section>
              ...
              <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                ...
                communications transmission is ever fully secure or error-free.
              </p>
            </section>
            ...
            <section>
              ...
              <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                ...
                time by logging into your online account or by emailing us. If
                you wish to delete or deactivate your account, please email us,
                but note that we may retain certain information as required by
            ...
            <section>
              ...
              <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                ...
                contact us at: privacy@carmine.com
              </p>
            </section>
          </div>
        </main>

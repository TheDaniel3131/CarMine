        ...
        <section className={`mb-24 ${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-3xl shadow-2xl p-12`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              ...
              { icon: Shield, title: "Expert Support", description: "Our team of automotive experts is always ready to assist you." },
              { icon: Star, title: "Community Driven", description: "Join a thriving community of car enthusiasts and experts." },

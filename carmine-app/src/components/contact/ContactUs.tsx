...
export default function ContactUs() {
  ...
  // Update form when authentication status or user email changes
  useEffect(() => {
    if (isAuthenticated && userEmail) {
      ...
      // User is logged out - clear email from form
      setFormData((prev) => ({
        ...prev,
        email: "",
      }));
  ...
  return (
    ...
    >
      <Header
        ...
        unreadMessages={0}
        onLogout={() => console.log("Logout clicked")} // Replace with actual logout function
      />
